CREATE TABLE [etlmanager].[ExecutionConcurrency]
(
	...
	CONSTRAINT [FK_ExecutionConcurrency_Job] FOREIGN KEY ([ExecutionId]) REFERENCES [etlmanager].[Execution] ([ExecutionId]) ON DELETE CASCADE,
