...
(
	...
	[InheritFromJobParameterId] UNIQUEIDENTIFIER NULL CONSTRAINT [FK_StepParameter_InheritFromJobParameter] FOREIGN KEY REFERENCES [biflow].[JobParameter] ([ParameterId]) ON DELETE SET NULL,
