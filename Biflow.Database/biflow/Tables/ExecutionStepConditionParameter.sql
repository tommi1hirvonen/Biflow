CREATE TABLE [biflow].[ExecutionStepConditionParameter]
(
	...
	CONSTRAINT [FK_ExecutionStepConditionParameter_ExecutionParameter] FOREIGN KEY ([ExecutionId], [ExecutionParameterId]) REFERENCES [biflow].[ExecutionParameter] ([ExecutionId], [ParameterId]),
	CONSTRAINT [FK_ExecutionStepConditionParameter_ExecutionStep] FOREIGN KEY ([ExecutionId], [StepId]) REFERENCES [biflow].[ExecutionStep] ([ExecutionId], [StepId]) ON DELETE CASCADE,
