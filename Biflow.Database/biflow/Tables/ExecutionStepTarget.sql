...
(
	...
	CONSTRAINT [FK_ExecutionStepTarget_ExecutionSourceTargetObject] FOREIGN KEY ([ExecutionId], [ObjectId]) REFERENCES [biflow].[ExecutionSourceTargetObject] ([ExecutionId], [ObjectId])
)