CREATE TABLE [biflow].[StepConditionParameter]
(
	...
	CONSTRAINT [FK_StepConditionParameter_StepId] FOREIGN KEY ([StepId]) REFERENCES [biflow].[Step] ([StepId]) ON DELETE CASCADE,
