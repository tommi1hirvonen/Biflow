...
(
	...
	CONSTRAINT [FK_ExecutionStepSource_ExecutionSourceTargetObject] FOREIGN KEY ([ExecutionId], [ObjectId]) REFERENCES [biflow].[ExecutionSourceTargetObject] ([ExecutionId], [ObjectId]) ON DELETE CASCADE
)