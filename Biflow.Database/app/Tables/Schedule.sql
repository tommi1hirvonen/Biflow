CREATE TABLE [app].[Schedule] (
    ...
    [DisallowConcurrentExecution]   BIT                 CONSTRAINT [DF_Schedule_DisallowConcurrentExecution] DEFAULT (0) NOT NULL,
    CONSTRAINT [PK_Schedule] PRIMARY KEY CLUSTERED ([ScheduleId] ASC),
    CONSTRAINT [FK_Schedule_Job] FOREIGN KEY ([JobId]) REFERENCES [app].[Job] ([JobId]) ON DELETE CASCADE,
