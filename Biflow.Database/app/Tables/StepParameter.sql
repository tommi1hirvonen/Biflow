CREATE TABLE [app].[StepParameter]
(
	...
	[InheritFromJobParameterId] UNIQUEIDENTIFIER NULL CONSTRAINT [FK_StepParameter_InheritFromJobParameter] FOREIGN KEY REFERENCES [app].[JobParameter] ([ParameterId]),
    [AssignToJobParameterId] UNIQUEIDENTIFIER NULL CONSTRAINT [FK_StepParameter_AssignToJobParameter] FOREIGN KEY REFERENCES [app].[JobParameter] ([ParameterId]),
	...
	CONSTRAINT [FK_StepParameter_StepId] FOREIGN KEY ([StepId]) REFERENCES [app].[Step] ([StepId]) ON DELETE CASCADE,
