CREATE TABLE [app].[PipelineClient]
(
	...
	[AppRegistrationId] UNIQUEIDENTIFIER NOT NULL CONSTRAINT [FK_DataFactory_AppRegistration] FOREIGN KEY REFERENCES app.AppRegistration ([AppRegistrationId]),
