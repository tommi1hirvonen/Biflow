CREATE TABLE [app].[ExecutionConcurrency]
(
	...
	CONSTRAINT [FK_ExecutionConcurrency_Job] FOREIGN KEY ([ExecutionId]) REFERENCES [app].[Execution] ([ExecutionId]) ON DELETE CASCADE,
