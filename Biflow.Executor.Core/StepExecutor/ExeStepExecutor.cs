    ...
    : StepExecutor<ExeStepExecution, ExeStepExecutionAttempt>(logger, dbContextFactory)
{
    ...
    protected override ExeStepExecutionAttempt Clone(ExeStepExecutionAttempt other, int retryAttemptIndex) =>
        new(other, retryAttemptIndex);

    protected override async Task<Result> ExecuteAsync(ExeStepExecution step, ExeStepExecutionAttempt attempt, ExtendedCancellationTokenSource cancellationTokenSource)
    {
