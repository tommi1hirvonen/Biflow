CREATE TABLE [etlmanager].[ExecutionStepAttempt] (
    ...
    CONSTRAINT [CK_ExecutionStepAttempt_StepType] CHECK ([StepType]='SSIS' OR [StepType]='SQL' OR [StepType]='JOB' OR [StepType]='PIPELINE' OR [StepType]='EXE' OR [StepType]='DATASET')
);