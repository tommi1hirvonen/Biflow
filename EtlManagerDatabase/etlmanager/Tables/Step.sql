CREATE TABLE [etlmanager].[Step] (
    ...
    [ResultCaptureJobParameterId]   UNIQUEIDENTIFIER NULL CONSTRAINT [FK_Step_JobParameter] FOREIGN KEY REFERENCES [etlmanager].[JobParameter] ([ParameterId]) ON DELETE SET NULL,
    ...
    [AppRegistrationId]             UNIQUEIDENTIFIER NULL CONSTRAINT [FK_Step_AppRegistration] FOREIGN KEY REFERENCES [etlmanager].[AppRegistration] ([AppRegistrationId]),
