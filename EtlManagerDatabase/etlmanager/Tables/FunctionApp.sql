...
(
	...
	[AppRegistrationId] UNIQUEIDENTIFIER NOT NULL CONSTRAINT [FK_FunctionApp_AppRegistration] FOREIGN KEY REFERENCES etlmanager.AppRegistration ([AppRegistrationId]),
