...
namespace Biflow.DataAccess.Migrations
{
    ...
    [Migration("20241209213221_FabricStep")]
    partial class FabricStep
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Biflow.Core.Entities.AccessToken", b =>
                {
                    ...
                    b.HasKey("AzureCredentialId", "Username", "ResourceUrl");
            ...
            modelBuilder.Entity("Biflow.Core.Entities.OrganizationalAccountCredential", b =>
                {
            ...
            modelBuilder.Entity("Biflow.Core.Entities.ServicePrincipalCredential", b =>
                {
                    b.HasBaseType("Biflow.Core.Entities.AzureCredential");
            ...
            modelBuilder.Entity("Biflow.Core.Entities.DataflowStep", b =>
                {
                    ...
                    b.Property<string>("DataflowGroupId")
                        .IsRequired()
                        .HasMaxLength(36)
                        .IsUnicode(false)
                        .HasColumnType("varchar(36)");
